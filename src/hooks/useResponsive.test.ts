...
describe('useResponsive', () => {
    ...
    it('returns default values when window is undefined (SSR)', () => {
        // Test SSR behavior by checking default values
        // The hook should return sensible defaults when window is not available

        // Test the getDeviceType function directly
        ...
        // Test that the hook uses correct defaults
